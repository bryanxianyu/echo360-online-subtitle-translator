...
GOOGLE_WEB_DEFAULT_CONCURRENCY = 8
GOOGLE_WEB_DEFAULT_MAX_CHARS = 4000
GOOGLE_WEB_DEFAULT_MAX_PARAGRAPHS = 80
...
def provider_defaults(provider: str) -> dict[str, int | str]:
    ...
    return {
        ...
        "max_chars": DEEPL_DEFAULT_MAX_CHARS,
