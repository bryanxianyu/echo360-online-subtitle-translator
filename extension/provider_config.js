(() => {
  ...
  const DEFAULTS = {
    ...
    deepl: { model: "", modelMode: "catalog", catalogModel: "", customModel: null, endpoint: "", reasoningEffort: "", deepseekThinkingMode: "disabled", deeplFormality: "", maxParagraphs: 6, maxChars: 1200, concurrency: 96, rps: 0, retries: 1, timeout: 10, fallbackMode: "immediate", repairConcurrency: 1, slowSplitThreshold: 0 },
  };
  const LEGACY_FIELDS = [
